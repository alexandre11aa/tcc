...
%Descrever de forma sucinta o que se espera como resultados da pesquisa proposta e o que isso trará de benefício para o meio científico ou para sociedade, caso estes sejam esperados e não tenham sido desenvolvidos ainda. Se houver resultados parciais, apresenta-los e discutí-los.
...
\begin{table}[ht]
\centering
\caption{Cronograma de pesquisa do primeiro semestre de 2023.}
\begin{tabular}{ccccccc}
\hline
\rowcolor[HTML]{C9C9C9} 
\textbf{Atividades} & \textbf{JAN} & \textbf{FEV} & \textbf{MAR} & \textbf{ABR} & \textbf{MAI} & \textbf{JUN} \\ \hline
\rowcolor[HTML]{EDEDED} 
\begin{tabular}[c]{@{}c@{}}Definição \\ do Problema\end{tabular} & X &  &  &  &  &  \\
\rowcolor[HTML]{FFFFFF} 
\begin{tabular}[c]{@{}c@{}}Formulação \\ dos objetivos\end{tabular} & X &  &  &  &  &  \\
\rowcolor[HTML]{EDEDED} 
\begin{tabular}[c]{@{}c@{}}Desenvolvimento \\ da justificativa\end{tabular} & X &  &  &  &  &  \\
\rowcolor[HTML]{FFFFFF} 
\begin{tabular}[c]{@{}c@{}}Revisão \\ Literária\end{tabular} &  & X & X & X &  &  \\
\rowcolor[HTML]{EDEDED} 
\begin{tabular}[c]{@{}c@{}}Elaboração do \\ referencial teórico\end{tabular} &  & X & X & X &  &  \\
\rowcolor[HTML]{FFFFFF} 
\begin{tabular}[c]{@{}c@{}}Definição da \\ metodologia\end{tabular} &  &  &  &  & X &  \\
\rowcolor[HTML]{EDEDED} 
\begin{tabular}[c]{@{}c@{}}Defesa \\ do TCC 1\end{tabular} &  &  &  &  &  & X \\
\hline
\end{tabular}
\caption*{\textbf{Fonte:} De autoria própria (2023).}
\end{table}
...
\begin{table}[ht]
\centering
\caption{Cronograma de pesquisa do segundo semestre de 2023.}
\begin{tabular}{ccccccc}
\hline
\rowcolor[HTML]{C9C9C9} 
\textbf{Atividades} & \textbf{JUL} & \textbf{AGO} & \textbf{SET} & \textbf{OUT} & \textbf{NOV} & \textbf{DEZ} \\ \hline
\rowcolor[HTML]{EDEDED} 
\begin{tabular}[c]{@{}c@{}}Desenvolvimento \\ da ferramenta\end{tabular} & X & X & X & X &  &  \\
\rowcolor[HTML]{FFFFFF} 
\begin{tabular}[c]{@{}c@{}}Elaboração \\ dos resultados\end{tabular} &  &  &  &  & X &  \\
\rowcolor[HTML]{EDEDED} 
\begin{tabular}[c]{@{}c@{}}Defesa \\ do TCC\end{tabular} &  &  &  &  &  & X \\
\hline
\end{tabular}
\caption*{\textbf{Fonte:} De autoria própria (2023).}
\end{table}